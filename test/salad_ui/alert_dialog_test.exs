defmodule SaladUI.AlertDialogTest do
  ...
  describe "alert_dialog/1" do
    test "renders with required attributes" do
      ...
      assert html =~ "Content"
      assert html =~ "relative z-50 group/alert-dialog"
    end
    ...
    test "raises when missing required id" do
      assigns = %{}
  ...
  describe "alert_dialog_header/1" do
    test "renders header with content" do
      ...
      for class <- ~w(flex flex-col space-y-2 text-center sm:text-left) do
        assert html =~ class
      end
    end
  ...
  describe "alert_dialog_footer/1" do
    test "renders footer with content" do
      ...
      for class <- ~w(flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2) do
        assert html =~ class
      end
    end
